...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId,Integer shippingId){
       ...
       List<OrderItem> orderItemList = (List<OrderItem>)serverResponse.getData();
        ...
        //生成成功，要减少的产品的库存
        this.reduceProducStock(orderItemList);
    ...
    //减少的产品的库存
    private void reduceProducStock(List<OrderItem> orderItemList) {
        for (OrderItem orderItem : orderItemList) {
    ...
    public ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            if (Const.ProductStatuEnum.ON_SALE.getCode() != product.getStatus()) {
